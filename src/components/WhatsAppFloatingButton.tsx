...
const WHATSAPP_URL = "https://w.app/cwzbt5";
...
export default function WhatsAppFloatingButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-28 right-4 z-[60] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_12px_30px_rgba(0,0,0,0.22)] transition duration-300 hover:-translate-y-1 hover:scale-[1.03] hover:bg-[#20BD5A] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#25D366]/30 sm:bottom-6 sm:right-6 sm:h-auto sm:w-auto sm:min-h-14 sm:gap-3 sm:px-5 sm:py-3"
    >
      <svg
        viewBox="0 0 32 32"
        aria-hidden="true"
