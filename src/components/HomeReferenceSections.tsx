...
function CategoryFramesSection() {
  const definitions = [
    { label: "Sensorial", category: "Sensorial", image: "/home-images/categoria-sensorial.webp" },
    { label: "Comunicação", category: "Comunicação", image: "/home-images/categoria-comunicacao.webp" },
    { label: "Motor", category: "Motor", image: "/home-images/categoria-motor.webp" },
    { label: "Autonomia", category: "Autonomia", image: "/home-images/categoria-rotina.webp" },
  ] as const;
