...
const localProductImages: Record<string, string> = {
  "cubo-sensorial.webp": "/home-images/produto-fidget.png",
  "colete-compressao.webp": "/home-images/produto-colete.png",
  "blocos-encaixe.webp": "/home-images/produto-blocos.png",
  "almofada-texturas.webp": "/home-images/galeria-nova-sensorial.png",
  "quebra-cabeca-rotinas.webp": "/home-images/produto-rotina.png",
};

function productImage(fileName: string) {
  if (r2BaseUrl) return `${r2BaseUrl}/products/${fileName}`;
  return localProductImages[fileName] || "";
}
